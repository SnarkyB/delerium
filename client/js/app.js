...
function genIV() { const iv = new Uint8Array(12); crypto.getRandomValues(iv); return iv; }
...
(async function () {
  ...
  if (!id || !frag) { content.textContent = "Missing paste ID or key."; return; }
